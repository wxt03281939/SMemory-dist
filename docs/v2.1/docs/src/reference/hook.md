...
当前插件公共方法都在 `_.__tools` 中，关于所有的公共方法可查看[此文件](https://github.com/wxt03281939/SMemory/blob/v2/src/utils/tools.js)
...
当前插件公共事件处理都在 `_.__event` 中，目前只有滚动事件和窗口大小事件的监听处理，源码可参考[此文件](https://github.com/wxt03281939/SMemory/blob/v2/src/components/event/event.js)。
