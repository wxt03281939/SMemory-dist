...
## 2025.01.01 - v2.1.7
* 更新APlayer CDN链接为staticfile源 [(#475)](https://github.com/wxt03281939/SMemory/pull/475)
* 修复状态组件URL中的哈希部分避免路由干扰 [(#476)](https://github.com/wxt03281939/SMemory/pull/476)
* 重构帖子元数据解析逻辑以提高可读性 [(#477)](https://github.com/wxt03281939/SMemory/pull/477)
* 重构文章目录组件，添加对标题编号的支持 [(#478)](https://github.com/wxt03281939/SMemory/pull/478)
* 优化标签页面代码结构，移除重复的postMeta函数 [(#479)](https://github.com/wxt03281939/SMemory/pull/479)
* 博客园评论排序兼容及样式调整 [(#457)](https://github.com/wxt03281939/SMemory/pull/457)
* 添加分类页和标签页的页面处理逻辑，包括标题设置、文章信息样式和摘要处理
* 使用更现代的数组处理方法替代原有实现，优化代码可读性
...
## 2024.12.09 - v2.1.6
* 修复侧边栏VIP样式异常 [(#444)](https://github.com/wxt03281939/SMemory/pull/444)
* font-family顺序调整 [(#449)](https://github.com/wxt03281939/SMemory/pull/449)
* 兼容博客园favicon更新 [(#453)](https://github.com/wxt03281939/SMemory/pull/453)
* 依赖版本更新

## 2024.07.04 - v2.1.5
* 文章页复制内容携带版权信息 [(#429)](https://github.com/wxt03281939/SMemory/pull/429)
* 文章页评论框打字动效 [(#431)](https://github.com/wxt03281939/SMemory/pull/431)
* 友链页增加配置 [(#435)](https://github.com/wxt03281939/SMemory/pull/435)
* 国家公祭日和自定义缅怀的日期 [(#439)](https://github.com/wxt03281939/SMemory/pull/439)
* 修复拓展图标展示异常 [(#436)](https://github.com/wxt03281939/SMemory/pull/436)
* 修复文章页关注博主按钮错位 [(#440)](https://github.com/wxt03281939/SMemory/pull/440)
...
## 2023.08.01 - v2.1.3
* 合并播放器功能 [(#388)](https://github.com/wxt03281939/SMemory/pull/388)
* 侧边栏是否展开配置 [(#387)](https://github.com/wxt03281939/SMemory/pull/387)
* 评论优化 [(#384)](https://github.com/wxt03281939/SMemory/pull/384)
* 头像旋转 [(#383)](https://github.com/wxt03281939/SMemory/pull/383)
* 修复未开启找一找功能显示异常的问题 [(#374)](https://github.com/wxt03281939/SMemory/pull/374)
* 文章分类和标签去除中间的逗号 [(#376)](https://github.com/wxt03281939/SMemory/pull/376)
* 对titleMsg显示进行优化 [(#378)](https://github.com/wxt03281939/SMemory/pull/378)
* 标题前缀图标 [(#379)](https://github.com/wxt03281939/SMemory/pull/379)
* markdown extend [(#380)](https://github.com/wxt03281939/SMemory/pull/380)
* 代码折叠 [(#381)](https://github.com/wxt03281939/SMemory/pull/381)
* 自定义飘落背景特效 [(#382)](https://github.com/wxt03281939/SMemory/pull/382)
* 文章评论背景 [(#386)](https://github.com/wxt03281939/SMemory/pull/386)
* 适配博客园VIP样式 [(#397)](https://github.com/wxt03281939/SMemory/pull/397)
* 统一使用webpack进行管理 [(#398)](https://github.com/wxt03281939/SMemory/pull/398)
* 当鼠标移动到右侧滚动条时，滚动条增加宽度 [(#399)](https://github.com/wxt03281939/SMemory/pull/399)
* 默认关闭文章页标题动效
* 增加配置 `animate.homeBannerTitle` 用以配置主页 banner 上 name 的动效
* 更新文档
* 更新基础样式
* 修复文章中文标题目录解析报错的问题 [(#377)](https://github.com/wxt03281939/SMemory/pull/377)
* 修复解析自动识别代码语言的信息出错
* 修复移动端出现白边的兼容性问题
* 修复文章目录锚点监听失败的问题
